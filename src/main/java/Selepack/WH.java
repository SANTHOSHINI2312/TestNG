...
public class WH {
	...
	Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//input[@class='zDPmFV']")).sendKeys("iphone",Keys.ENTER);
...
//WebElement iphone=	driver.findElement(By.xpath("//div[@class='yKfJKb row']//div[contains(text(),'Apple iPhone 16 (Black, 128 GB')]"));
		//WebElement iphone=driver.findElement(By.xpath("//div[text()='Apple iPhone 16 (Black, 128 GB)iphone.click();
	...
	addtocartrealme.click();
		...
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("8098928066");
